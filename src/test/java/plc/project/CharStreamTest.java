...
public class CharStreamTest {
    public static void main(String args[]) {
        ...
        lexer = new Lexer("<=1");
        System.out.println("current char digit1?  " + lexer.peek("<="));
        System.out.println("current char digit2?  " + lexer.match("<="));
        System.out.println("current char digit3?  " + lexer.peek("1"));
    }
}
