...
//Ast.Source {
//	fields = [
//		Ast.Field { name = 'i', value = Optional[Ast.Expr.Literal{literal=-1}] }
//		Ast.Field { name = 'inc', value = Optional[Ast.Expr.Literal{literal=2}] }
//	]
//
//	methods = [
//		Ast.Method {
...
//						operator = '<=',
//						left = Ast.Expr.Access{receiver=Optional.empty, name='i'},
//						right = Ast.Expr.Literal{literal=1}
//					},
//					statements = [
//					    Ast.Stmt.If {
//							condition = Ast.Expr.Binary {
//								operator = '>',
//								left = Ast.Expr.Access{receiver=Optional.empty, name='i'},
//								right = Ast.Expr.Literal{literal=0}
//							},
//							thenStatements = [
//								Ast.Stmt.Expression {
//									expression = Ast.Expr.Function {
//										receiver = Optional.empty,
//										name = 'print',
//										arguments = [ Ast.Expr.Literal{literal=bar} ]
//									}
//								}
//							],
//							elseStatements=[]
//						},
//						Ast.Stmt.Assignment {
//							receiver = Ast.Expr.Access{receiver=Optional.empty, name='i'},
//							value = Ast.Expr.Binary {
//								operator = '+',
//								left = Ast.Expr.Access{receiver=Optional.empty, name='i'},
//								right = Ast.Expr.Access{receiver=Optional.empty, name='inc'}
//							}
//						}
//					]
//				}
